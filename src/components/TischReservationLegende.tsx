      ...
      <div className="row justify-content-center rounded-2 border border-warning m-2 Reservierung-Legende">
        <div className=" col-12 col-md-6 p-4 mx-3 d-flex justify-content-between">
          <div className="d-flex flex-column align-items-center">
            <div className="rounded-circle circle FreeTable" />
            <span className="fw-bold text-start">Frei</span>
          </div>
          <div className="d-flex flex-column align-items-center">
            <div className="rounded-circle circle bg-danger" />
            <span className="fw-bold text-center">Belegt</span>
          </div>
          <div className="d-flex flex-column align-items-center">
            <div className="rounded-circle circle SelectedTable" />
            <span className="fw-bold text-end">Ausgewählt</span>
          </div>
        </div>

        <div className="col-12 d-flex justify-content-center align-items-center border-top border-warning border-3 m-2">
          <button className="btn btn-success my-2 Table FreeTable" />
        ...
        <div className="d-flex justify-content-center align-items-center">
          <button className="btn rounded-circle  my-2 Table SelectedTable" />
          <span className="fw-bold fs-5 mx-2">
