              ...
              buttonMapper.map((_, buttonMapperIndex) => {
                return (
                  <button
                    ...
                    className={
                      choose[buttonMapperIndex + 20 + elementMapperIndex]
                        ? "btn position-relative SelectedTable Table-Large my-2"
                        : "btn position-relative FreeTable Table-Large my-2"
                    }
                    onClick={() => {
                      setChoose(
                  ...
                  >
                    <Users
                      fill="gray"
                      className="position-absolute usersLeft"
                    />
                    <Users
                      fill="gray"
                      className="position-absolute usersRight"
                    />
                  </button>
                );
              })}
